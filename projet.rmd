...
Enfin, on peut remarquer que l'attribut "UpperCase" est plus proche du nuage de points que l'attribut "LowerCase". Cela semble indiquer qu'écrire les titres en majuscule attire davantage les utilisateurs du site.
